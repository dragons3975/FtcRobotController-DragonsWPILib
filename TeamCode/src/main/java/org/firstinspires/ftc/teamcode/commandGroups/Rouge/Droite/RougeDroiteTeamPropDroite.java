...
public class RougeDroiteTeamPropDroite extends SequentialCommandGroup {
    ...
    public RougeDroiteTeamPropDroite(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, PinceSubsystem pinceSubsystem, BrasSubsystem brasSubsystem) {
