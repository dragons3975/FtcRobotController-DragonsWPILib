...
public class AscenseurManualMonterCommand extends CommandBase {

    private final AscenseurSubsystem mAscenseurSubsystem;
    private final Telemetry mTelemetry;

    public AscenseurManualMonterCommand(Telemetry telemetry, AscenseurSubsystem ascenseurSubsystem){
