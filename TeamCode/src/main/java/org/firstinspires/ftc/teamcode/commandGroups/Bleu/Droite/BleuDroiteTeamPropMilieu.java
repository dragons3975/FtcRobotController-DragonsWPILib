...
public class BleuDroiteTeamPropMilieu extends SequentialCommandGroup {
    ...
    public BleuDroiteTeamPropMilieu(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, PinceSubsystem pinceSubsystem, BrasSubsystem brasSubsystem) {
