...
public class RougeGaucheTeamPropDroite extends SequentialCommandGroup {
    ...
    public RougeGaucheTeamPropDroite(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, PinceSubsystem pinceSubsystem, BrasSubsystem brasSubsystem) {
