...
public class BleuGaucheTeamPropDroite extends SequentialCommandGroup {
    ...
    public BleuGaucheTeamPropDroite(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, PinceSubsystem pinceSubsystem, BrasSubsystem brasSubsystem) {
