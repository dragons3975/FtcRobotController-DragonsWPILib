...
public class BrasRotationPosCommand extends Command{

    private final BrasSubsystem mBrasSubsystem;

    private final double mPos;

    public BrasRotationPosCommand(BrasSubsystem brasSubsystem, double pos) {
        mPos = pos;
    ...
    public void initialize() {
        mBrasSubsystem.setTargetRotation(mPos);
    }
