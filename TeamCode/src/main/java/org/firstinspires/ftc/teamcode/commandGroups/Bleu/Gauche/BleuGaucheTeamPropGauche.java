...
public class BleuGaucheTeamPropGauche extends SequentialCommandGroup {
    ...
    public BleuGaucheTeamPropGauche(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, PinceSubsystem pinceSubsystem, BrasSubsystem brasSubsystem) {
