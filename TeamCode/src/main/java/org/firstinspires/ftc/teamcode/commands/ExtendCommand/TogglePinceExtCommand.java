...
public class TogglePinceExtCommand extends Command {

    private final PinceExtensionSubsystem mPinceExtensionSubsystem;

    public TogglePinceExtCommand(PinceExtensionSubsystem pinceExtensionSubsystem) {
    ...
    public void initialize() {
        if (mPinceExtensionSubsystem.isOpen()) {
