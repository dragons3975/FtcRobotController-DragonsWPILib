...
public class AscenseurManualDescendreCommand extends CommandBase {

    private final AscenseurSubsystem mAscenseurSubsystem;
    private final Telemetry mTelemetry;

    public AscenseurManualDescendreCommand(Telemetry telemetry, AscenseurSubsystem ascenseurSubsystem){
