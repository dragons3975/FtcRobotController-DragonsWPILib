...
public class RougeDroiteTeamPropMilieu extends SequentialCommandGroup {
    ...
    public RougeDroiteTeamPropMilieu(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, PinceSubsystem pinceSubsystem, BrasSubsystem brasSubsystem) {
